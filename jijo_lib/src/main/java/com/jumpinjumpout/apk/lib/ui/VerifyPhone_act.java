		...
		buttonVerifyPhoneNo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				try {
					...
					msPhoneNo.replace(" ", "");
					String sPreviousCode = CGlobals_lib
							.getInstance()
							.getSharedPreferences(getApplicationContext())
							.getString(Constants_lib.PREF_VERIFICATION_CODE,
									"x1531352");
					if (!TextUtils.isEmpty(msPhoneNo)) {
						CGlobals_lib
								...
								.putString(Constants_lib.PREF_PHONENO,
										msPhoneNo);
						CGlobals_lib
								.getInstance()
								.getSharedPreferencesEditor(
					...
					if (msPhoneNo.contains("12345")
						...
						CGlobals_lib
								...
								.getSharedPreferencesEditor(
                                        getApplicationContext())
								.putBoolean(Constants_lib.PREF_REGISTERED, true);
						if (!TextUtils.isEmpty(msPhoneNo)) {
							CGlobals_lib
									.getInstance()
									.getSharedPreferencesEditor(
							...
							msPhoneNo = CGlobals_lib
									.getInstance()
									.getSharedPreferences(
                                            getApplicationContext())
									.getString(Constants_lib.PREF_PHONENO, "");
						...
						CGlobals_lib
								...
								.getSharedPreferencesEditor(
                                        getApplicationContext())
								.putString(Constants_lib.PREF_COUNTRY_CODE,
										msCountryCode);
						CGlobals_lib
								.getInstance()
								.getSharedPreferencesEditor(
					...
					CGlobals_lib
							...
							.getSharedPreferencesEditor(
                                    getApplicationContext())
							.putString(Constants_lib.PREF_VERIFICATION_CODE,
									msCode);
					CGlobals_lib
							.getInstance()
							.getSharedPreferencesEditor(
			...
			public void onReceive(Context context, Intent intent) {
				...
				if (body.contains(msCode)) {
					...
					CGlobals_lib
							...
							.getSharedPreferencesEditor(
                                    getApplicationContext())
							.putString(Constants_lib.PREF_PHONENO, msPhoneNo);
					CGlobals_lib
							.getInstance()
							.getSharedPreferencesEditor(
                                    getApplicationContext())
