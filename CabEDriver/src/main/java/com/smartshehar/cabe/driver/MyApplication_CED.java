...
public class MyApplication_CED extends Application {
    private String TAG = "MyApplication_CabE: ";
    private static MyApplication_CED sInstance;
    ...
    public static synchronized MyApplication_CED getInstance() {
        return sInstance;
    }
        ...
        if (mPrefsVersionPersistent == null) {
            mPrefsVersionPersistent = getApplicationContext()
                    .getSharedPreferences(
                            Constants_CED.PREFS_VERSION_PERSISTENT,
