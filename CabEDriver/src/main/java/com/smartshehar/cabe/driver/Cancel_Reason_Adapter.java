...
public class Cancel_Reason_Adapter extends BaseAdapter {
    private static ArrayList<CTrip_CED> CTrip_CED_Array_List;

    private LayoutInflater mInflater;
    Context context;

    public Cancel_Reason_Adapter(Context context, ArrayList<CTrip_CED> results) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(
                    R.layout.driver_cancel_trip, null);
        ...
        holder.tvCancelResonItem.setText(CTrip_CED_Array_List.get(position).getCancel_Reason());
        return convertView;
    }
