...
public class PassengerAdapter_Jump extends BaseAdapter {
    private static String TAG = "PassengerAdapter";
    private ArrayList<CTrip_CED> aPassengerList;
    Context context;
    private int iJumpIn, iJumpOut;

    public PassengerAdapter_Jump(Context c, ArrayList<CTrip_CED> d) {
        this.context = c;
        aPassengerList = d;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.passenger_item_list_jump, null);
        ...
        } else if (!aPassengerList.get(position).hasJumpedIn() && !aPassengerList.get(position).hasJumpedOut()) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                if (sJumpIn.equals("jumpin")) {
                    params.put("jumpin", "1");
                } else if (sJumpIn.equals("jumpout")) {
