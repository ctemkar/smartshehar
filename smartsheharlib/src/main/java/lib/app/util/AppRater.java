...
public class AppRater {
    ...
    public static void app_launched(Context mContext, String apptitle, String packagename) {
    	APP_TITLE = apptitle;
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        final String sURL = "https://play.google.com/store/apps/details?id=" + mPackageName;
