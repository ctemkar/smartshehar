...
/**
 * The configuration screen for the SAppWidgetProvider widget sample.
 */
public class ExampleAppWidgetConfigure extends Activity {


    private static final String PREFS_NAME
            = "com.example.android.apis.appwidget.SAppWidgetProvider";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            SAppWidgetProvider.updateAppWidget(context, appWidgetManager,
