...
/**
 * A BroadcastReceiver that listens for updates for the SAppWidgetProvider.  This
...
public class ExampleBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.d("ExmampleBroadcast", "intent=" + intent);
...
/*            ExampleAppWidgetConfigure.loadAllTitlePrefs(context, appWidgetIds, texts);*/
            ...
            for (int i=0; i<N; i++) {
                SAppWidgetProvider.updateAppWidget(context, gm, appWidgetIds.get(i), texts.get(i));
            }
        }
    }
