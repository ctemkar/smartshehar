...
/**
 * Created by jijo_soumen on 01/03/2016.
 */
public class ShareDriverLocationFriend extends AppCompatActivity
        implements
    ...
    private static final String TAG = "ShareDriver: ";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(ShareDriverLocationFriend.this)
                .addApi(LocationServices.API)
                .addApi(Places.GEO_DATA_API)
                .addApi(Places.PLACE_DETECTION_API)
                .addConnectionCallbacks(ShareDriverLocationFriend.this)
                .addOnConnectionFailedListener(ShareDriverLocationFriend.this)
                .build();
        mGoogleApiClient.connect();
        mCurrentLocation = CGlobals_user.getInstance().getBestLocation(ShareDriverLocationFriend.this);
        if (mCurrentLocation != null) {
            Toast.makeText(this, "Got Location!", Toast.LENGTH_SHORT).show();
        }
        CGlobals_user.getInstance().init(this);
        CGlobals_user.getInstance().getMyLocation(ShareDriverLocationFriend.this);
        ActionBar ab = getSupportActionBar();
        // ab.setHomeButtonEnabled(true);
        setContentView(R.layout.activity_walkwithme);
        if (!mConnectivity.checkConnected(ShareDriverLocationFriend.this)) {
            if (!mConnectivity.connectionError(ShareDriverLocationFriend.this, getString(R.string.app_label))) {
                if (mConnectivity.isGPSEnable(ShareDriverLocationFriend.this)) {
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (CGlobals_user.inWalkWithMe) {    // Stop WalkWithMe
                    ...
                    stopService(new Intent(ShareDriverLocationFriend.this, LocationService.class));
                    ...
                    if (sEmails.contains("@") && sEmails.contains(".")) {
                        ...
                        stopService(new Intent(ShareDriverLocationFriend.this, LocationService.class));
                        startService(new Intent(ShareDriverLocationFriend.this, LocationService.class));
                        sendLocation();
                    } else {
                        Toast.makeText(ShareDriverLocationFriend.this, "Please enter valid email id/s", Toast.LENGTH_SHORT).show();
                    }
                }
                writePrefs();
                finish();
    ...
    private void sendLocation() {
        ...
        final int miTripId = MyApplication.getInstance().getPersistentPreference()
        ...
        try {
            ...
            StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                        ...
                        public void onResponse(String response) {
                            ...
                            if (!response.trim().equals("-1")) {
                                if (CGlobals_user.walkWithMeMode.equals("A")) {
                                    Toast.makeText(ShareDriverLocationFriend.this,
                                            "Email sent to: " + sEmails +
                                                    " to 'Walk with you'\n They will see your position on a map",
                                            Toast.LENGTH_LONG).show();
                                }
                            } else {
                                Toast.makeText(ShareDriverLocationFriend.this, "Could not send request ", Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                protected Map<String, String> getParams() {
                    ...
                    Location location = CGlobals_user.getInstance().getMyLocation(ShareDriverLocationFriend.this);
                    ...
                    SharedPreferences mSettings = PreferenceManager.getDefaultSharedPreferences(ShareDriverLocationFriend.this);
                    ...
                    try {
                        if (location != null) {
                            CGeo geo = new CGeo(ShareDriverLocationFriend.this);
                    ...
                    params = CGlobals_user.getInstance().getBasicMobileParams(params,
                            url, ShareDriverLocationFriend.this);
    ...
    protected void onResume() {
        ...
        readPrefs();
        if (CGlobals_lib.haveNetworkConnection(ShareDriverLocationFriend.this) == 0) {
            try {
                mTvStatus = (TextView) findViewById(R.id.tvStatus);
        ...
        if (!isServiceRunning(ShareDriverLocationFriend.this, "com.jumpinjumpout.apk.user.LocationService_user")) {
            CGlobals_user.inWalkWithMe = false;
        }
