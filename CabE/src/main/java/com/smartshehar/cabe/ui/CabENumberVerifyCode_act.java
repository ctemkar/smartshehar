 ...
 * Number Verify generated 4 digit code
 */
public class CabENumberVerifyCode_act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mConnectivity.connectionError(CabENumberVerifyCode_act.this, getString(R.string.app_label))) {
    ...
    public void initToolBar() {
        ...
        if (actionBar != null) {
            actionBar.setTitle("Cab-e Verify code");
        }
        tvCabENextTop = (TextView) findViewById(R.id.tvCabENextTop);
        tvCabENextTop.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onClickNextBottom(View view) {
        msPhoneNo = CGlobals_lib_ss.getInstance().getPersistentPreference(CabENumberVerifyCode_act.this)
                .getString(Constants_lib_ss.PREF_PHONENO, "");
        msCode = CGlobals_lib_ss.getInstance().getPersistentPreference(CabENumberVerifyCode_act.this)
                .getString(Constants_lib_ss.PREF_VERIFICATION_CODE, "");
    ...
    public void sendUserAccess() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST,
                Constants_CabE.USER_ACCESS_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                if (!TextUtils.isEmpty(MyApplication_CabE.getInstance().getPersistentPreference().getString(
                        Constants_CabE.PREF_REG_ID, ""))) {
                    params.put("gcmregid", MyApplication_CabE.getInstance().getPersistentPreference().getString(
                            Constants_CabE.PREF_REG_ID, ""));
                }
                params.put("usertype", Constants_CabE.USER_TYPE);
                params = CGlobals_lib_ss.getInstance().getAllMobileParams(params,
                        Constants_CabE.USER_ACCESS_URL, Constants_CabE.APP_CODE, CabENumberVerifyCode_act.this);
                String delim = "";
    ...
    private void userAccessSucess(String response) {
        ...
        try {
            if (response.trim().equals("-1")) {
                CGlobals_lib_ss.getInstance().getPersistentPreferenceEditor(CabENumberVerifyCode_act.this)
                        .putBoolean(Constants_CabE.PREF_CABE_NUMBER_VERIFY_DONE, false);
                CGlobals_lib_ss.getInstance().getPersistentPreferenceEditor(CabENumberVerifyCode_act.this).commit();
            ...
            if (sAppUserId.trim().equals("-1")) { // registration probably
                ...
                CGlobals_lib_ss.getInstance().getPersistentPreferenceEditor(CabENumberVerifyCode_act.this).
                        putInt(Constants_CabE.PREF_APPUSERID, iAppUserId);
                CGlobals_lib_ss.getInstance().getPersistentPreferenceEditor(CabENumberVerifyCode_act.this)
                        .putBoolean(Constants_CabE.PREF_CABE_NUMBER_VERIFY_DONE, true);
                CGlobals_lib_ss.getInstance().getPersistentPreferenceEditor(CabENumberVerifyCode_act.this).commit();
