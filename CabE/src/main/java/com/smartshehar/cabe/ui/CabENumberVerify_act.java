 ...
 * Verify phone number using sms
 * passenger number by sending sms to their own phone
 */

public class CabENumberVerify_act extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    String msISOCountryCode = "", msCountryCode = "";
    ...
    public void initToolBar() {
        ...
        if (actionBar != null) {
            actionBar.setTitle("Cab-e Number Verify");
        }
        ...
        tvCabENext2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    msPhoneNo = etNumber.getText().toString().trim();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params = CGlobals_lib_ss.getInstance().getAllMobileParams(params,
                        url, Constants_CabE.APP_CODE, CabENumberVerify_act.this);
                String delim = "";
